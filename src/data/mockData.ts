...
const mockCustomers: CustomerProfile[] = [
  {
    ...
    language: 'en',
    platform: 'whatsapp',
    tags: ['VIP客户', '批发商', '电子产品', '高预算', '高购买意向', '决策者', '紧急采购'],
    aiProfile: {
      customerLevel: 'VIP客户',
      customerType: '批发商',
      intendedCategory: '电子产品',
      budgetRange: '高预算',
      purchaseUrgency: '紧急',
      inquiryStage: '成交客户',
      decisionRole: '决策者',
  ...
  },
  {
    ...
    language: 'ja',
    platform: 'line',
    tags: ['C级客户', '零售客户', '服装配饰', '中等预算', '初步询盘', '中等紧迫'],
    aiProfile: {
      customerLevel: '新客户',
      customerType: '零售客户',
      intendedCategory: '服装配饰',
      budgetRange: '中等预算',
      purchaseUrgency: '中等',
      inquiryStage: '初步询盘',
      decisionRole: '使用者',
  ...
  },
  {
    ...
    language: 'zh',
    platform: 'wechat',
    tags: ['B级客户', '批发商', '智能穿戴', '高预算', '高意向', '决策者'],
    aiProfile: {
      customerLevel: '优质客户',
      customerType: '批发商',
      intendedCategory: '智能穿戴',
      budgetRange: '高预算',
      purchaseUrgency: '中等',
      inquiryStage: '报价阶段',
      decisionRole: '决策者',
  ...
  },
  {
    ...
    language: 'en',
    platform: 'instagram',
    tags: ['B级客户', '零售客户', '时尚服饰', '中高预算', '高意向', '年轻群体'],
    aiProfile: {
      customerLevel: '潜力客户',
      customerType: '零售客户',
      intendedCategory: '时尚服饰',
      budgetRange: '中高预算',
      purchaseUrgency: '较高',
      inquiryStage: '产品咨询',
      decisionRole: '使用者',
  ...
  },
  {
    ...
    language: 'ko',
    platform: 'telegram',
    tags: ['A级客户', '零售客户', '美妆护肤', '高预算', '高意向', '复购客户'],
  ...
  },
  {
    ...
    language: 'it',
    platform: 'facebook',
    tags: ['B级客户', '零售客户', '家居用品', '中高预算', '中等意向', '设计偏好'],
