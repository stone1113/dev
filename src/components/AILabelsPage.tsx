...
const DimensionGroup: React.FC<{
  ...
  <div className="border-b border-gray-100 last:border-b-0">
    <div className="flex items-center gap-3 px-4 py-3 bg-gray-50/70">
      <span className="w-3 h-3 rounded-full flex-shrink-0 bg-[#FF6B35]" />
...
const FieldRow: React.FC<{
  ...
  <div className="flex items-center gap-3 px-4 py-2.5 pl-8 hover:bg-gray-50/50 transition-colors group border-b border-gray-50 last:border-b-0">
    <div className="flex items-center gap-2 w-36 flex-shrink-0">
      <span className="w-2.5 h-2.5 rounded flex-shrink-0 bg-gray-400" />
      ...
      {field.inputType === 'text' ? (
        ...
        <>
          {values.map((val) => (
            <span
              key={val.id}
              className="inline-flex items-center px-2 py-0.5 text-xs rounded-full border border-gray-200 bg-gray-50 text-gray-700"
            >
              {val.name}
            </span>
          ))}
    ...
    <span className="px-2 py-0.5 text-[11px] font-medium rounded-full flex-shrink-0 bg-gray-100 text-gray-600">
