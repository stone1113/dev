    ...
    <div className="relative">
      ...
      >
        {selectedAccount ? (
          ...
          <>
            ...
            {!compact && (
              <span className="flex-1 text-left text-xs text-gray-500">选择账号</span>
            )}
            <ChevronDown className={cn(
              "text-gray-400",
              compact ? "w-3 h-3" : "w-4 h-4"
      ...
      {isOpen && (
        <>
          ...
          />
          <div className={cn(
            "absolute z-50 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden",
            compact ? "left-0 right-0 mt-1" : "left-0 right-0 mt-1"
          )}>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 text-left">
                    <div className="flex items-center gap-2">
                      ...
                      {account.isDefault && (
                        <span className="px-1.5 py-0.5 text-[9px] bg-[#0059F8]/10 text-[#0059F8] rounded-full">
                          默认
                        </span>
                      )}
                    </div>
